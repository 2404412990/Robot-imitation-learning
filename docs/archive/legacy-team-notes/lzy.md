...
修复一些unity平台内重定向和ui的bug，增加lite_11_v1这一型号的机器人（仅限后端，前端没做增加）

# 2026.6.26

增加一个新分支，此分支内ui逻辑变成勾选机器人以及多机器人同时重定向

<img width="2151" height="1639" alt="image" src="https://github.com/user-attachments/assets/28a688da-67c3-4268-b446-2ffb352260a0" />
